...
import org.todoporunalma.api.infrastructure.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Public endpoints (both with and without context-path "/api")
                        .requestMatchers(
                                "/auth/**", "/health", "/actuator/**",
                                "/api/auth/**", "/api/health", "/api/actuator/**",
